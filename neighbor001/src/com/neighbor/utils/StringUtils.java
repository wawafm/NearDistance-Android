...
public class StringUtils {
	...
	public static String escapeForXML(String string) {
		...
		return stripNonValidXMLCharacters(out.toString());
	}
	 ...
	 * @return
	 */
	public static String phoneFilter(String src){
	 ...
	 * @return
	 */
	public static String locationFileter(String src){
		if(!StringUtils.isEmpty(src)){
			return src.replace("市", "").replace("省", "");
		}else 
			return "";
	}
}
