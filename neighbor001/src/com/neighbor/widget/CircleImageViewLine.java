...
public class CircleImageViewLine extends ImageView{
    ...
    public CircleImageViewLine(Context paramContext) {  
        super(paramContext);  
    }  
  
    public CircleImageViewLine(Context paramContext, AttributeSet paramAttributeSet) {  
        this(paramContext, paramAttributeSet, 0);  
    }  
  
    public CircleImageViewLine(Context paramContext, AttributeSet paramAttributeSet, int paramInt) {  
    ...
    protected void onDraw(Canvas paramCanvas) {  
        ...
        /** 设置drawable的大小 */  
        localDrawable.setBounds(25, 40, width-25, height-45);  
